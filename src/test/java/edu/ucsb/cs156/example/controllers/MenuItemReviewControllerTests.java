...
public class MenuItemReviewControllerTests extends ControllerTestCase{
    ...
    public void logged_in_user_can_get_all_menuItemReviews() throws Exception {
        ...
        expectedReviews.addAll(Arrays.asList(menuItemReviewOne, menuItemReviewTwo));
    ...
    public void an_admin_user_can_post_a_new_menuitemreview() throws Exception {
        ...
        MvcResult response = mockMvc.perform(
                        post("/api/menuitemreviews/post?itemId=1&reviewerEmail=test1@example.com&comments=Great item!&stars=5&dateReviewed=2022-01-03T00:00:00")
                                        .with(csrf()))
                        .andExpect(status().isOk()).andReturn();
    ...
    public void admin_can_edit_an_existing_menuitemreview() throws Exception {
        ...
        verify(menuItemReviewRepository, times(1)).save(menuItemReviewTwo); // should be saved with correct user
        String responseString = response.getResponse().getContentAsString();
