...
public class UCSBDiningCommonsMenuItemsIT {
        ...
        @Test
        public void an_admin_user_can_post_a_new_ucsb_dining_commons_menu_items() throws Exception {
                // arrange
                ...
                MvcResult response = mockMvc.perform(
                                post("/api/ucsbdiningcommonsmenuitems/post?diningCommonsCode=Portola&name=Pasta&station=Brick")
                                                .with(csrf()))
                                .andExpect(status().isOk()).andReturn();
